...
import {View, Form, Button, Image, TextInput,KeyboardAvoidingView, ScrollView} from 'react-native';
  ...
  useEffect(() => {
    ...
    async function init() {
      ...
      const G$ = await sf.loadSuperToken(
        '0x7a5f9c3e43aadc62647ab5d41802db33dc7d8c4b',
      );
