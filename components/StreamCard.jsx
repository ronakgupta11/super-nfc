  ...
  return (
    <Surface mode="flat" >
     ...
     <Surface mode="flat" style={{marginLeft:10}} >
        <Text variant='bodyLarge' style={{color:`${type==0?"green":theme.colors.error}`}} onPress={()=>navigation.navigate("StreamDetails",{timeStamp:time,recipentAddress:address,type:type,streamRate:StreamRateConverted,blockNumber:blockNo,totalStreamed:""})} >{StreamType[type]}</Text>
